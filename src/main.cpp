      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
			...
			// reference x, y, yaw states //wt
			double ref_x = car_x;
			double ref_y = car_y;
			double ref_yaw = deg2rad(car_yaw);

			// if previous size is almost empty, use the cae as starting reference //wt
			if(prev_size < 2)
			{
				//Use two points that make the path tangent to the car //wt
			...
			//Use the previous path's end point as starting reference //wt
			else
			{
				//redefine reference state as previous path end point //wt
				...
				//use two points that make the path tangent to the previous path's end point //wt
			...
			{
				//shift car reference angle to 0 degrees //wt
			...
			{   
				...
				// rotate backfrom the local coordinates to the global coodinates
